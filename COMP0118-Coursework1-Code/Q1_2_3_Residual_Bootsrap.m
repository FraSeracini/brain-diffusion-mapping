...
% Apply the Residual Bootstrap algorithm
for t = 1 : T
    ...
    A_resampled = (A_est + resampled_residuals)';
...
sigma_ranges_rb = Two_Sigma_Range(residual_samples);
ninety_five_range_rb = NinetyFive_Range(residual_samples);
