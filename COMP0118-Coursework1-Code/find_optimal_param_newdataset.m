function [best_parameters, min_RESNORM, RESNORM_per_start_point] = find_optimal_param_newdataset(Model_Name, startx, num_runs, Avox, bvals, qhat)
% This function is optimized for the data set used in section 1.3 and 1.4
% This function searches for the global minimum of the objective function
% for the Ball-and-Stick and Zeppelin-and-Stick with Tortuosity models 
% by performing multiple optimization runs from different starting points.
%
% INPUTS:
...
for n = 1 : num_runs
    ...
    startx_n(1) = startx(1) + randn*1e+00;
